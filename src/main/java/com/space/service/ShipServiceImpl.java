...
public class ShipServiceImpl implements ShipService {
  ...
  @Override
  public Ship editShip(Long id, Ship ship) throws BadRequestException, ShipNotFoundException {
    checkShipParams(ship);
  ...
  private void checkShipParams(Ship ship) throws BadRequestException {
  ...
  @Override
  public Long checkAndParseId(String id) throws BadRequestException {
